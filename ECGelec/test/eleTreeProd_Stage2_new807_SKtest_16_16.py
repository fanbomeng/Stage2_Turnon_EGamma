...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2016D/DoubleEG/RAW-RECO/ZElectron-PromptReco-v2/000/276/315/00000/12C9D229-0545-E611-8F5B-02163E0129BD.root'),
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_271036-276811_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt').getVLuminosityBlockRange()
...
process.TFileService = cms.Service ("TFileService",
                                    fileName = cms.string ("tree_testFastSim_TPG_checknow_debug_16_16_277194.root")
                                    )
