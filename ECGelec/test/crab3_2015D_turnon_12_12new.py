...
config.General.requestName = 'ECAL_turnon_2016D_12_12_277194newiso'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'eleTreeProd_Stage2_new807_SKtest_12_12.py'

#config.Data.inputDataset = '/DoubleElectron/Run2012D-ZElectron-22Jan2013-v1/RAW-RECO'
config.Data.inputDataset = '/DoubleEG/Run2016E-ZElectron-PromptReco-v2/RAW-RECO'
...
config.Data.lumiMask ='https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions16/13TeV/Cert_271036-277933_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt' 
#config.Data.runRange = '193093-193999' # '193093-194075'
#config.Data.runRange = '203777-208686' # '193093-194075'
#config.Data.runRange = '256729-258443' # all for D data 203777-208686
config.Data.runRange = '277193-277195' # all for D data 203777-208686
