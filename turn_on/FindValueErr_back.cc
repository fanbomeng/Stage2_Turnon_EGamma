...
int prodResults(TString dir="/afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/", TString file="eff_EG20_tagWP80_probeWP80_EB_N_vs_EE_N", TString namews="workspace", int nbdata=10000, double et_plateau=100, 
		bool draw=false, bool verbose=false) 
{
