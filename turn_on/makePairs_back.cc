...
void makePairs(int nEntries,  string dirOut, TString dirIn, TString data, string nameChain,  TString RunPhase, bool debug){
  ...
  // files.push_back("tree_changed_080.root");
  // files.push_back("tree_changed_085.root");
  // files.push_back("tree_changed_088.root");
  // files.push_back("tree_changed_092.root");
  // files.push_back("tree_changed_094.root");
    
  files.push_back("Tutanon/tree_changed_22_1_ocM.root");
  files.push_back("Tutanon/tree_noChange_47_1_dpd.root"); 
  files.push_back("Tutanon/tree_changed_080_9_1_Jg3.root");
  files.push_back("Tutanon/tree_changed_085_22_1_RxS.root");
