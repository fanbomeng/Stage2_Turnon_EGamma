...
//   		       kBlack, kFullCircle, kRed, kOpenSquare, "WP80", "WP80");
  fastEfficiencySilvia(numberEG,
                       numberEG,0,2,0,3, "/2016/effi_TagProbe_elepairs_2016SK_14_14_online.root","effi_TagProbe_elepairs_2016SK_hallo.root",
   		       "SK_12_12", "SK_hallo", mydir.str(), 0, 0, 4, 
...
void fastEfficiencySilvia(unsigned int iEG1, unsigned int iEG2, int iECAL1, int iColl1, int iECAL2, int iColl2, 
  ...
  name_image.str("");
  name_image << dirResults.str() <<"SK_"<<"hallo"<< "eff_EG"<<names[iEG1]<<"_EG"<<names[iEG2]<<"_tag"<<tag<<"_probe"<<probe<<name_ecal[iECAL1]<<name_coll[iColl1]<<"_vs"<<name_ecal[iECAL2]<<name_coll[iColl2] ;
  if (DEBUG) cout << __LINE__ << endl;
