...
//   		       kBlack, kFullCircle, kRed, kOpenSquare, "WP80", "WP80");
  fastEfficiencySilvia(20,20,0,8,0,8, "../../DoubleEG_l1t_integr_v49.0_15.05.2016_273158/selectPairsDir/effi_TagProbe_tree.root","effi_TagProbe_tree.root",
   		       "Old", "New", mydir.str(), 0, 0, 4, 
