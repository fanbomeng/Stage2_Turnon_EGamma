...
int main(int argc, char**argv){
  ...
  TApplication app("App",&argc, argv);
   ...
   fastEfficiencySilvia(25, 0,1, 0, 1,  "result/tree_effi_TagProbe360_369_normal.root","result/tree_effi_TagProbe360_369_LC.root", 
   		       "FGVB ratio theshold 0.90", "FGVB ratio threshold 0.95", mydir.str(), "19.7 fb^{-1}", 4, 
   		       kBlack, kFullCircle, kRed, kOpenSquare, "WP80", "WP80");

//  fitManyFiles(20, 0, 1, 0, 1,  "effi_TagProbe_tree_*.root",
//	       "FGVB ratio theshold 0.90", "FGVB ratio threshold 0.95", mydir.str(), "19.7 fb^{-1}", 4, 
//	       kBlack, kFullCircle, kRed, kOpenSquare, "WP80", "WP80");
  app.Run(); 
